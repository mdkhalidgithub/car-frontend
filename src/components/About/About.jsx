...
function About() {
  ...
  return (
    <div
      className="dark:bg-black bg-slate-100 dark:text-white duration-300 sm:min-h-[600px] sm:grid sm:place-items-center"
    >
      <div
        className="grid grid-cols-1 sm:grid-cols-2 place-items-center"
      >
        <div
        ...
        <div>
          <div className="space-y-5 sm:p-16 pb-6">
            ...
            <p data-aos='fade-up'>
              ...
              — whether you're planning a road trip, attending a business meeting, or just need a car for the day.
            </p>
            <p data-aos='fade-up'>
              ...
              From compact cars to premium SUVs, we’ve got something for every need and budget.
            </p>
